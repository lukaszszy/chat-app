  ...
  <body class="min-h-screen flex flex-col">
    ...
    <div class="flex-1 content-wrapper flex items-center justify-center w-full relative">
      ...
      <div id="hello-container" class="w-[60%] flex flex-col space-y-3 mt-4" style="display: block;">
        ...
        The data controller is Adam Mickiewicz University in Poznań, located at Wieniawskiego 1, 61-712 Poznań, Poland. For matters related to personal data protection, please contact us at: [data protection email address].</p>

        <p><strong>2. Scope of Collected Data</strong><br>
        ...
        <p><strong>4. Use of AI Technology</strong><br>
        ...
        <p><strong>6. Data Recipients</strong><br>
